...
%% Colaboradores:
%%          CÃ©sar M. Vargas Benitez <cesarvargasb@gmail.com>
%%          Marcos Talau <talau@users.sourceforge.net>


\documentclass[openright]{normas-utf-tex} %openright = o capÃ­tulo comeÃ§a sempre em paginas impares.  
...
%---------- Primeiro Capitulo ----------
\chapter{\MakeUppercase{Introdu\c{c}\~ao}}
...
\section{\MakeUppercase{Motiva\c{c}\~ao}}
...
\section{\MakeUppercase{Equa\c{c}\~oes}}
...
\section{\MakeUppercase{Siglas e s\'imbolos}}
...
%---------- Terceiro Capitulo ----------
\chapter{\MakeUppercase{Conclus\~ao}}
...
%---------- Apendices (opcionais) ----------
\apendice
\chapter{\MakeUppercase{Nome do Ap\^endice}}
...
% ---------- Anexos (opcionais) ----------
\anexo
\chapter{\MakeUppercase{Nome do Anexo}}
...
% --------- Lista de siglas --------
%\textbf{* Observa\c{c}\~oes:} a lista de siglas nÃ£o realiza a ordenaÃ§Ã£o das siglas em ordem alfabÃ©tica. \\
% Em breve isso serÃ¡ implementado, enquanto isso:
%\textbf{Sugest\~ao:} crie outro arquivo .tex para siglas e utilize o comando \sigla{sigla}{descri\c{c}\~ao}.
%Para incluir este arquivo no final do arquivo, utilize o comando \input{arquivo.tex}.
%Assim, Todas as siglas serao geradas na Ãºltima pÃ¡gina. Entao, deverÃ¡ excluir a Ãºltima pÃ¡gina da versao final do arquivo
% PDF do seu documento.


%-------- Citacoes ---------
% - Utilize o comando \citeonline{...} para citaÃ§Ãµes com o seguinte formato: Autor et al. (2011).
% Este tipo de formato Ã© utilizado no comeÃ§o do parÃ¡grafo. P.ex.: \citeonline{autor2011}

% - Utilize o comando \cite{...} para citaÃ§Ãµes no meio ou final do parÃ¡grafo. P.ex.: \cite{autor2011}



%-------- TÃ­tulos com nomes cientÃ­ficos (tÃ­tulo, capÃ­tulos e seÃ§Ãµes) ----------
% Regra para escrita de nomes cientÃ­ficos:
% Os nomes devem ser escritos em itÃ¡lico, 
%a primeira letra do primeiro nome deve ser em maiÃºsculo e o restante em minÃºsculo (inclusive a primeira letra do segundo nome).
% VEJA os exemplos abaixo.
%Assim, o comando \Makeuppercase foi removido da classe normas-utf-tex.cls.
%Utilize o comando \Makeuppercase nos tÃ­tulos dos capÃ­tulos e seÃ§Ãµes.
%Exemplos: \chapter{\\Makeuppercase{Metodologia}} 
%\section{\MakeUppercase{Estudo dos efeitos da radiaÃ§Ã£o ultravioleta C e TFD em cÃ©lulas de} {\textit{Saccharomyces boulardii}}
%\titulo{\MakeUppercase{Estudo dos efeitos da radiaÃ§Ã£o ultravioleta C e TFD em cÃ©lulas de} {\textit{Saccharomyces boulardii}}
